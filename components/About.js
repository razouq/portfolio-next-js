export default function About() {
  return (
    <section className=" flex flex-col sm:flex-row items-center bg-blue-50 mt-5 shadow-md">
      <div className="w-1/3 m-5 mt-10 rounded-full overflow-hidden">
        <img src="/images/avatar.png" alt="avatar" />
      </div>
      <div className="w-2/3 m-5">
        <p className="text-center text-gray-700 font-bold text-base sm:text-3xl">
