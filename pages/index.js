  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-6 py-8">
        <section class="bg-white dark:bg-gray-800 my-5">
          <h1 className="text-gray-800 text-3xl text-center">Projects</h1>
          <div class="container mx-auto px-6 py-8 my-3">
            <div class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                <h1 class="mt-4 font-semibold text-xl text-gray-800 dark:text-white">
